...
if (file_exists($_SERVER['DOCUMENT_ROOT'] . '/bitrix/components/bitrix/tasks.automation/class.php')) {
    require_once $_SERVER['DOCUMENT_ROOT'] . '/bitrix/components/bitrix/tasks.automation/class.php';
}
...
?>
    ...
    $APPLICATION->includeComponent(
            'baarlord.b24automationexpander:tasks.automation',
            '',
            array(
